...
description: [Bun](https://bun.com/) + [TypeScript](https://www.typescriptlang.org/) backend server with WebSocket support, [Redis](https://redis.io/) integration, and cryptographic authentication.
---
