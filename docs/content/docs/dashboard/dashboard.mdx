---
title: Dashboard
description: [Flask](https://flask.palletsprojects.com/en/stable/)-based web interface for system monitoring, [Redis](https://redis.io/) management, and firewall control with real-time statistics.
---
